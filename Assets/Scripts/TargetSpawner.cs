...
{
    public int targetsSpawned = 0; // Keeps track the number of targets that spawned (for future score calculations)
    public float timeSpawned;
    public float averageTimeSpawned; // TO DO
    public int targetsSpawnedRef = 0;
    
    public GameObject targetObject; // Creates the target that spawns in our grid (Can be anything)
    public List<Transform> gridLocations; // List of Transform locations so I can choose where the targets spawn
    ...
    public void timeIncrease()
    {
        ...
        //averageTimeSpawned += timeSpawned;
    }
}
